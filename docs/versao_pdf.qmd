...
esperar uma produção média do produto 1 de `r as.integer(prod1_media)`m³, com um
intervalo de confiança de `r as.integer(prod1_inf)`m³ a `r as.integer(prod1_sup)`m³. Sendo o
...
De acordo com os dados obtidos no processamento do inventário, pode-se
esperar uma produção média do produto 2 de `r as.integer(prod2_media)`m³, com um
intervalo de confiança de `r as.integer(prod2_inf)`m³ a `r as.integer(prod2_sup)`m³. Sendo o
...
De acordo com os dados obtidos no processamento do inventário, pode-se
esperar uma produção média do produto 3 de `r as.integer(prod3_media, 2)`m³, com um
intervalo de confiança de `r as.integer(prod3_inf)`m³ a `r as.integer(prod3_sup)`m³. Sendo o
